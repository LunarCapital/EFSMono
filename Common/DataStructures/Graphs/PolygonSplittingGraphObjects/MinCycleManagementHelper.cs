...
namespace EFSMono.Common.DataStructures.Graphs.PolygonSplittingGraphObjects
{
    ...
    public static class MinCycleManagementHelper
    {
        ...
        {
            if (cyclePerim is null) throw new ArgumentNullException(nameof(cyclePerim));
        ...
        {
            if (groupNodesPerim is null) throw new ArgumentNullException(nameof(groupNodesPerim));
