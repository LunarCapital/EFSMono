...
using Godot;
using static EFSMono.Common.DataStructures.Graphs.PolygonSplittingGraphObjects.MinCycleManagementHelper;
...
namespace EFSMono.Common.DataStructures.Graphs.PolygonSplittingGraphObjects
{
    ...
    public static class MinCycleProcessingHelper
    {
        ...
        public static List<ChordlessPolygon> PartitionConnectedNodeGroup(ConnectedNodeGroup connectedGroup,
                                                                    ...
                                                                    List<Vector2>[] holes)
        {
            if (connectedGroup is null) throw new ArgumentNullException(nameof(connectedGroup));
            if (idsContainedInGroup is null) throw new ArgumentNullException(nameof(idsContainedInGroup));
            if (connectedGroups is null) throw new ArgumentNullException(nameof(connectedGroups));
