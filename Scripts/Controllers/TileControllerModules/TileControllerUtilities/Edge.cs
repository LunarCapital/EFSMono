...
public class Edge : Reference
{
    ...
    public Edge Clone()
    {
        return (Edge)base.MemberwiseClone();
    }
    ...
    {
        Edge reversedEdge = new Edge(this.b, this.a, this.tileCoords, this.tileSide);
        reversedEdge.isChecked = this.isChecked;
        return reversedEdge;
    }
    ...
    public Edge GetShiftedByN(int n)
    {
        ...
        Edge shiftedEdge = new Edge(shiftedA, shiftedB, shiftedTilecoords, this.tileSide);
        return shiftedEdge;
    }
    ...
    {
        if (this.a == comparisonEdge.a && this.b == comparisonEdge.b ||
